...
entry_num2.pack()
boton_sumar = tk.Button(ventana, text="Sumar", command=sumar, bg="Orange", fg="White", width=10, height=3,font=("Arial", 20))
boton_sumar.pack()
boton_restar = tk.Button(ventana, text="Restar", command=restar, bg="orange", fg="White", width=10, height=3,font=("Arial", 20))
boton_restar.pack()
